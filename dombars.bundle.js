(function(e){if("function"==typeof bootstrap)bootstrap("dombars",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makeDOMBars=e}else"undefined"!=typeof window?window.DOMBars=e():global.DOMBars=e()})(function(){var define,ses,bootstrap,module,exports;
  ...
  for (var i = 0; i < statements.length; i++) {
    ...
    if (statement.type === 'block') {
      if (statement.program) {
        statement.program = parseHTML(statement.program);
      }

      if (statement.inverse) {
        statement.inverse = parseHTML(statement.inverse);
      }
    }
  }
...
var parseHTML = function (originalProgram) {
  var yy   = HbsParser.yy;
...
Parser.prototype.parse = function (input) {
  ...
  // original nodes back.
  return parseHTML(HbsParser.parse(input));
};
